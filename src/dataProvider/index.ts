...
const defaultDataProvider: DataProvider = {
  create: () => Promise.resolve({ data: { id: 0 } } as CreateResult),
  delete: () => Promise.resolve({ data: {} } as DeleteResult),
  deleteMany: () => Promise.resolve({}),
  getList: () => Promise.resolve({ data: [], total: 0 }),
  getMany: () => Promise.resolve({ data: [] }),
  getManyReference: () => Promise.resolve({ data: [], total: 0 }),
  getOne: () => Promise.resolve({ data: {} } as GetOneResult),
  update: () => Promise.resolve({ data: {} } as UpdateResult),
